                ...
                signInSignUpButton(
                  ...
                  () {
                    FirebaseAuth.instance.createUserWithEmailAndPassword(
                        ...
                        password: passwordTextController.text).then((value) {print("Created New Error");
                          Navigator.push(context,
                        MaterialPageRoute(builder: (context) => TabScreen(widget.favoriteMeal)));}).onError((error, stackTrace) {
