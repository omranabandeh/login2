...
class DrawerScreen extends StatelessWidget {
  ...
  DrawerScreen({required this.favoriteMeal});
  @override
      ...
      child: ListView(
        children: [
          ...
          ListTile(
            ...
            title: Text('Log Out'),
onTap: (){
              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> SignInScreen(favoriteMeal, favoriteMeal: favoriteMeal)));
},          )
        ],
      ),
    );
